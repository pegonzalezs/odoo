...
##############################################################################
{
    ...
    6) After the previous steps, the Account Mapping Rules engine determine the general account to assign for the transaction.
    ...
    'depends': ['account_voucher', 'base_iban', 'l10n_be_invoice_bba', 
        'account_bank_statement_extensions', 'account_bank_statement_extensions'],
    'demo_xml': [],
    'init_xml': [
