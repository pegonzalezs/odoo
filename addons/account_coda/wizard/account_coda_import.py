        ...
        for line in recordlist:
            ...
            if not line:
                ...
                if coda_bank:
                    ...
                    company_currency_id = company_obj.read(cr, uid, company_id, ['currency_id'])['currency_id'][0]
                ...
                if coda_statement['new_balance_date']:                
                    period_id = period_obj.search(cr , uid, [('date_start' ,'<=', coda_statement['new_balance_date']), ('date_stop','>=',coda_statement['new_balance_date']), ('company_id', '=', company_id)])
                else:
                    period_id = period_obj.search(cr , uid, [('date_start' ,'<=', coda_statement['date']), ('date_stop','>=',coda_statement['date']), ('company_id', '=', company_id)])
                if not period_id:
