        ...
        if (book_taxes_back) {
            if (amount && account_id) {
                deferred_tax = self.model_tax
                    .call("json_friendly_compute_all_book_taxes_back", [[tax_id], amount, self.get("currency_id"), self.get("mv_lines_selected"), self.st_line, line_created_being_edited, line_created_being_edited[0]])
                    .then(function (data) {
