...
instance.web.FormView = instance.web.View.extend(instance.web.form.FieldManagerMixin, {
    ...
    load_form: function(data) {
        ...
        this.$buttons.on('click', '.oe_form_button_save_and_edit',
                         this.guard_active(this.on_button_save_and_edit));
    ...
    on_button_save_and_edit: function(e) {
        var self = this;
        $(e.target).attr("disabled", true);
        return this.save().done(function(result) {
            self.trigger("save", result);
    ...
    _search_create_popup: function(view, ids, context) {
        ...
        pop.select_element(
            self.field.relation,
            {
                ...
                width: (view === 'search' ? self.options.search_width : self.options.create_width),
                height: (view === 'search' ? self.options.search_height : self.options.create_height),
        ...
        this.$follow_button.click(function(ev) {
            ...
            pop.show_element(
                ...
                self.build_context(),
                {
                    ...
                    width: (self.options.create_width),
                    height: (self.options.create_height),
                    min_width: self.options.min_width,
...
instance.web.form.One2ManyListView = instance.web.ListView.extend({
        ...
        if (this.editable()) {
            ...
            pop.select_element(
                self.o2m.field.relation,
                {
                    ...
                    child_name: self.o2m.name,
                    form_view_options: {'not_interactible_on_create':true},
                    width: self.o2m.options.create_width,
                    height: self.o2m.options.create_height,
                    min_width: self.o2m.options.min_width
                },
    ...
    do_activate_record: function(index, id) {
        ...
        pop.show_element(self.o2m.field.relation, id, self.o2m.build_context(), {
            ...
            height: self.o2m.options.create_height,
            min_width: self.o2m.options.min_width,
            max_height: self.o2m.options.max_height
        });
    },
...
instance.web.form.Many2ManyListView = instance.web.ListView.extend(/** @lends instance.web.form.Many2ManyListView# */{
    do_add_record: function () {
        ...
        pop.select_element(
            this.model,
            {
                ...
                width: this.m2m_field.options.search_width,
                height: this.m2m_field.options.search_height,
                min_width: this.m2m_field.options.min_width,
                max_height: this.m2m_field.options.max_height || this.m2m_field.options.search_height,
            },
    ...
    do_activate_record: function(index, id) {
        ...
        pop.show_element(this.dataset.model, id, this.m2m_field.build_context(), {
            ...
            width: (self.m2m_field.options.create_width),
            height: (self.m2m_field.options.create_height),
            min_width: self.m2m_field.options.min_width,
            max_height: self.m2m_field.options.max_height,
        });
...
instance.web.form.AbstractFormPopup = instance.web.Widget.extend({
    ...
    display_popup: function() {
        ...
        var dialog = new instance.web.Dialog(this, {
            ...
            width: self.options.width || "90%",
            height: self.options.height || 'auto',
            min_width: self.options.min_width || '800px',
            max_height: self.options.max_height || self.options.height
        }, this.$el).open();
