    ...
    def _product_reserve(self, cr, uid, ids, product_id, product_qty, context=None, lock=False):
        ...
        for id in locations_ids:
            ...
            if compare_qty == 1:
                ...
                product_qty -= amount
                total -= amount
                # HACK: 17.06.2014 13:46:46: olivier: check with uom_rounding instead of 0.0 (because product_qty was somethimes like 9.999993434e-13)
                if product_qty <= uom_rounding:
                    return result
                # HACK: 17.06.2014 13:46:46: olivier: check with uom_rounding instead of 0.0 (because product_qty was somethimes like 9.999993434e-13)
                if total <= uom_rounding:
                    continue
        return False
...
class stock_move(osv.osv):
    ...
    def action_consume(self, cr, uid, ids, quantity, location_id=False, context=None):
        ...
        for move in self.browse(cr, uid, ids, context=context):
            ...
            # HACK: 16.07.2014 16:20:40: olivier: FLOAT Problem -> check if abs(quantity_rest) is greater than 0 but smaller than 0.000001 (this should be enough) -> if yes, set it to 0
            if quantity_rest > 0 and abs(quantity_rest) < 0.000001:
                quantity_rest = 0
